...
for dd3 in ddd3:
    ...
    for i in range(1,999999):
        ...
        # 请求的URL
        url = f'https://vip.stock.finance.sina.com.cn/quotes_service/api/json_v2.php/Market_Center.getHKStockData?page={i}&num=40&sort=symbol&asc=1&node={dd3[2]}&_s_r_a=init'
    ...
    ##    ddd2 = json.loads(ddd2)
        ...
        for dd2 in ddd2:
            if dd2["symbol"] not in ddd.keys():
                ddd[dd2["symbol"]]=[dd2["name"], dd2["engname"], dd2["tradetype"], f"@{dd3[0]}"]
            else:
                ddd[dd2["symbol"]].append(f"@{dd3[0]}")
