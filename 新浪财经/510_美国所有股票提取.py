...
for i in range(1,999999):
    ...
    # 请求的URL
    # https://stock.finance.sina.com.cn/usstock/api/jsonp.php/IO.XSRV2.CallbackList['fa8Vo3U4TzVRdsLs']/US_CategoryService.getList?page=1&num=20&sort=&asc=0&market=&id=
    url=f"https://stock.finance.sina.com.cn/usstock/api/jsonp.php/IO.XSRV2.CallbackList['f0j3ltzVzdo2Fo4p']/US_CategoryService.getList?page={i}&num=60&sort=&asc=0&market=&id="
...
##    ddd2 = json.loads(ddd2)
    ...
    for dd2 in ddd2:
        if dd2["symbol"] not in ddd.keys():
            ddd[dd2["symbol"]]=[dd2["name"], dd2["cname"], f"@{dd2['category']}", dd2["market"]]
