...
for i in range(1,999999):
    ...
    # 请求的URL
    url = f'https://vip.stock.finance.sina.com.cn/quotes_service/api/json_v2.php/Market_Center.getHKStockData?page={i}&num=40&sort=symbol&asc=1&node=qbgg_hk&_s_r_a=page'
...
##    ddd2 = json.loads(ddd2)
    ...
    for dd2 in ddd2:
        if dd2["symbol"] not in ddd.keys():
            ddd[dd2["symbol"]]=[dd2["name"], dd2["engname"], dd2["tradetype"]]
