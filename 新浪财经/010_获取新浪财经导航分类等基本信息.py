...
# 请求的URL
url = f'https://vip.stock.finance.sina.com.cn/quotes_service/api/json_v2.php/Market_Center.getHQNodes'
...
with open(f'000_新浪导航分类等基本信息.txt', 'w', encoding='utf-8', newline='\r\n') as f:
