...
# 请求的URL
url = f'https://vip.stock.finance.sina.com.cn/quotes_service/api/json_v2.php/Market_Center.getANHData?page=1&num=40&sort=hrap&asc=0&node=aplush&_s_r_a=init'  # 这一页已经包含全部了
...
for dd2 in ddd2:
    #if dd2["h"] in ddd.keys():
    #ddd[dd2["h"]]=[dd2["name"], dd2["engname"], dd2["tradetype"]]
    ddd[dd2["h"]].append(f"@A+H:{dd2['a']}")
