...
with open('data/100_香港股票symbol信息.txt', 'r', encoding='utf-8-sig', newline='\r\n') as f:
    ddd=json.loads(f.read())

with open('data/000_香港股票_行业股票_临时.txt', 'r', encoding='utf-8-sig', newline='\r\n') as f:
...
for dd2 in ddd2["data"]["list"]:
    ddd[dd2["symbol"]].append(f"@{ddd3['8000']}")  # ------------
