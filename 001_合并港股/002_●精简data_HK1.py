...
for ff in file_names:
    if ff.find("_d.txt")>-1:
        ...
        #ddd2=[[dd[0],round(dd[2]-dd[9],2),dd[1],dd[4],dd[3],dd[2],dd[5],dd[6],dd[10]] for dd in ddd]
        ddd2=[[dd[0],dd[1],dd[4],dd[3],dd[2],dd[9],dd[8],dd[5],dd[6],dd[10]] for dd in ddd]

        with open(f'data\\HK1\\{ff}', 'w', encoding='utf-8', newline='\r\n') as f:
