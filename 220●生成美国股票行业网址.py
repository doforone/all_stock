...
# https://stock.xueqiu.com/v5/stock/screener/quote/list.json?page=1&size=30&order=desc&order_by=percent&market=US&ind_code=403010

with open('data/雪球_美国股票_行业分类.txt', 'r', encoding='utf-8-sig', newline='\r\n') as f:
    ddd=json.loads(f.read())
    

for dd in ddd["data"]["industries"]:
    #print(f"https://stock.xueqiu.com/v5/stock/screener/quote/list.json?page=1&size=999999&order=desc&order_by=percent&market=US&ind_code={dd['encode']}")
    print(f"https://stock.xueqiu.com/v5/stock/screener/quote/list.json?ind_code={dd['encode']}&page=1&size=999999&order=desc&order_by=percent&market=US")


##with open(f'data/100_香港股票symbol信息.txt', 'w', encoding='utf-8', newline='\r\n') as f:
