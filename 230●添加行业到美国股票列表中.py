...
with open('data/200_美国股票symbol信息.txt', 'r', encoding='utf-8-sig', newline='\r\n') as f:
    ddd=json.loads(f.read())

with open('data/000_美国股票_行业股票_临时.txt', 'r', encoding='utf-8-sig', newline='\r\n') as f:
...
print(f"@{ddd3[classs]}")
for dd2 in ddd2["data"]["list"]:
    if dd2["symbol"] in ddd.keys():
        ddd[dd2["symbol"]].append(f"@{ddd3[classs]}")
    else:
        ddd[dd2["symbol"]]=[dd2["name"],f"@{ddd3[classs]}"]


with open(f'data/200_美国股票symbol信息.txt', 'w', encoding='utf-8', newline='\r\n') as f:
