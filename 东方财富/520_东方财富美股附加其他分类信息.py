...
for i in range(1,999999):
    ...
    # 请求的URL
    url = f'https://16.push2.eastmoney.com/api/qt/clist/get?cb=jQuery11240732185185746191_1707190446278&pn={i}&pz=20&po=1&np=1&ut=bd1d9ddb04089700cf9c27f6f7426281&fltt=2&invt=2&wbp2u=|0|0|0|web&fid=f3&fs=i:100.NDX,i:100.DJIA,i:100.SPX&fields=f1,f2,f3,f4,f5,f6,f7,f8,f9,f10,f12,f13,f14,f15,f16,f17,f18,f20,f21,f23,f24,f25,f26,f22,f33,f11,f62,f128,f136,f115,f152,f124,f107&_=1707190447681'
...
##            ddd[dd2["f12"]]=[dd2["f14"]]
    ...
    for dd2 in ddd2:
        if dd2["f12"] not in ddd.keys():
            ddd[dd2["f12"]]=[dd2["f14"],f"&美股指数"]
        else:
            ddd[dd2["f12"]].append(f"&美股指数")  # RM:热门概念,GN:概念板块,#:地域板块,*:分类,&美股指数

with open(f'000_东方财富美国全部股票.txt', 'w', encoding='utf-8', newline='\r\n') as f:
