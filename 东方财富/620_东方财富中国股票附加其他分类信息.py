...
for i in range(1,999999):
    ...
    # 请求的URL
    url = f'https://13.push2.eastmoney.com/api/qt/clist/get?cb=jQuery112405013360582208337_1707227905559&pn={i}&pz=20&po=1&np=1&ut=bd1d9ddb04089700cf9c27f6f7426281&fltt=2&invt=2&wbp2u=|0|0|0|web&fid=f3&fs=b:DLMK0101&fields=f1,f2,f3,f4,f5,f6,f7,f8,f9,f10,f12,f13,f14,f15,f16,f17,f18,f20,f21,f23,f24,f25,f22,f11,f62,f128,f136,f115,f152,f191,f192,f193,f186,f185,f187,f189,f188&_=1707227906201'
...
##            ddd[dd2["f12"]]=[dd2["f14"]]
    ...
    for dd2 in ddd2:
        if dd2["f12"] not in ddd.keys():
            ddd[dd2["f12"]]=[dd2["f14"],f"@中证系列指数"]
        else:
            ddd[dd2["f12"]].append(f"@中证系列指数")  # RM:热门概念,GN:概念板块,#:地域板块,*:分类,&美股指数


##    for dd2 in ddd2:
##        if dd2["f191"] not in ddd.keys():
##            ddd[dd2["f191"]]=[dd2["f193"],f"@A+H:{dd2['f12']}"]
##        else:
##            ddd[dd2["f191"]].append(f"@A+H:{dd2['f12']}")  # RM:热门概念,GN:概念板块,#:地域板块,*:分类,&美股指数

            
##    for dd2 in ddd2:
##        if dd2["f12"] not in ddd.keys():
##            ddd[dd2["f12"]]=[dd2["f14"],f"@深证AB股比价:{dd2['f201']}"]
##        else:
##            ddd[dd2["f12"]].append(f"@深证AB股比价:{dd2['f201']}")  # RM:热门概念,GN:概念板块,#:地域板块,*:分类,&美股指数
