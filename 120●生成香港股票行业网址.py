...
# https://stock.xueqiu.com/v5/stock/screener/quote/list.json?page=1&size=30&order=desc&order_by=percent&market=HK&ind_code=7030&is_delay=true

with open('data/雪球_香港股票_行业分类.txt', 'r', encoding='utf-8-sig', newline='\r\n') as f:
    ddd=json.loads(f.read())
    

for dd in ddd["data"]["industries"]:
    print(f"https://stock.xueqiu.com/v5/stock/screener/quote/list.json?\
page=1&size=999999&order=desc&order_by=percent&market=HK&\
ind_code={dd['encode']}&is_delay=true")
