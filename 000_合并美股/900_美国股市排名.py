...
print("-------- 2024年02月24日 美股市值排名 --------")
print("")
print("注：按流通股计算。")
print("")
summ=0
n=1
for dd in list(ddd.keys())[:100]:
    print(f"{n}: {dd}  {ddd[dd][4]}  {round(ddd[dd][2]/100000000,2)}亿美元  {ddd[dd][0]}")
    summ+=ddd[dd][2]
    n+=1

print("")
print(f"以上市值总计：{round(summ/100000000,2)}亿美元")
print("")
print("--end--")
