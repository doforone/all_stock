...
if __name__ == "__main__":
    ...
    for dd in ddd.keys():
        if ddd[dd][1]==1:
            for d in ddd[dd][6]:
                if d=="中国概念股":
                    sss+=f"&ensp;<a href='/data/US0/{dd}_d.html'>{dd}：{ddd[dd][4]}</a>&ensp;|"
                    #sss+=f"<a href='/data/US0/{dd}_d.html'>{dd}：{ddd[dd][4]}</a>&ensp;&ensp;"
                    break
    ...
    sss="<p>"
    for dd in ddd.keys():
        if ddd[dd][1]==1 and ddd[dd][0]=="NASDAQ":
            sss+=f"&ensp;<a href='/data/US0/{dd}_d.html'>{dd}：{ddd[dd][4]}</a>&ensp;|"
            #sss+=f"<a href='/data/US0/{dd}_d.html'>{dd}：{ddd[dd][4]}</a>&ensp;&ensp;"
    ...
    sss="<p>"
    for dd in ddd.keys():
        if ddd[dd][1]==1 and ddd[dd][0]=="NYSE":
            sss+=f"&ensp;<a href='/data/US0/{dd}_d.html'>{dd}：{ddd[dd][4]}</a>&ensp;|"
            #sss+=f"<a href='/data/US0/{dd}_d.html'>{dd}：{ddd[dd][4]}</a>&ensp;&ensp;"
    ...
    sss="<p>"
    for dd in ddd.keys():
        if ddd[dd][1]==1 and ddd[dd][0]=="AMEX":
            sss+=f"&ensp;<a href='/data/US0/{dd}_d.html'>{dd}：{ddd[dd][4]}</a>&ensp;|"
            #sss+=f"<a href='/data/US0/{dd}_d.html'>{dd}：{ddd[dd][4]}</a>&ensp;&ensp;"
    ...
    for uu in uuu.keys():
        if uu!="中国概念股" and uu[:5]!="知名美股:":
            ...
            sss="<p>"
            for dd in ddd.keys():
                if ddd[dd][1]==1 and uu in ddd[dd][6]:
                    sss+=f"&ensp;<a href='/data/US0/{dd}_d.html'>{dd}：{ddd[dd][4]}</a>&ensp;|"
            sss+="</p>"
