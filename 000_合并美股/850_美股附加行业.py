...
for dd in ddd.keys():
    if ddd[dd][1]==1 and dd in ddd0.keys():
        if ddd0[dd][2]!="@None" and ddd0[dd][2]!="@":
            if ddd0[dd][2][1:] not in ddd[dd][6]:
                ddd[dd][6].append(ddd0[dd][2][1:])

            if ddd0[dd][2][1:] not in www.keys():
                www[ddd0[dd][2][1:]]=1
            else:
                www[ddd0[dd][2][1:]]+=1
...
for dd in ddd.keys():
    if ddd[dd][1]==1 and dd in ddd0.keys():
        for d0 in ddd0[dd][1:]:
            if d0[:1]=="@" and d0!="@":
                if d0[1:] not in ddd[dd][6]:
                    ddd[dd][6].append(d0[1:])

                if d0[1:] not in www.keys():
                    www[d0[1:]]=1
                else:
                    www[d0[1:]]+=1
