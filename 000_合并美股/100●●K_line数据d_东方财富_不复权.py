...
while ddd!=[]:
    ...
    if dd[2]==1:  # 可以更新的美股
        print(f"---{len(ddd)}---")
        #=================
        if os.path.exists(f'data/US_不复权/{dd[0]}_d.txt'):
            with open(f'data/US_不复权/{dd[0]}_d.txt', 'r', encoding='utf-8-sig', newline='\r\n') as f:
        ...
        if typee!="":
            url=f"https://push2his.eastmoney.com/api/qt/stock/kline/get?cb=jQuery35107839036194425375_1707274807249&\
secid={typee}.{dd[0]}&ut=fa5fd1943c7b386f172d6893dbfba10b&fields1=f1%2Cf2%2Cf3%2Cf4%2Cf5%2Cf6&fields2=f51%2Cf52%2Cf53%2Cf54%2Cf55%2Cf56%2Cf57%2Cf58%2Cf59%2Cf60%2Cf61&\
klt=101&fqt=0&end=20500101&lmt={lmt}&_={int(time.time()*1000)}"
            try:
                ...
                if lmt==FF:
                    with open(f'data/US_不复权/{dd[0]}_d.txt', 'w', encoding='utf-8', newline='\r\n') as f:
...
with open(f'_new_data_US0.txt', 'w', encoding='utf-8', newline='\r\n') as f:
...
# 启动第一个程序
# 这里假设第一个程序是 test1.py
os.system("python 110_●不复权数据US0上传同步.py")
